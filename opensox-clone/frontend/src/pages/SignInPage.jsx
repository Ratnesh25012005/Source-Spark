...
function SignInPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || err.response?.data?.errors?.[0]?.msg || 'Unable to sign in');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="auth-shell glass-card">
        <section className="auth-panel">
          ...
          <div className="auth-body">
            ...
            <h1>Sign in to your account<span>.</span></h1>
            ...
            <form onSubmit={handleSubmit} className="auth-form auth-form--modern">
              ...
              <div className="auth-cta-row">
                <button
                  ...
                  onClick={() => setForm({ email: 'demo@sourcespark.dev', password: 'password123' })}
                >
                  Use Demo
                </button>
